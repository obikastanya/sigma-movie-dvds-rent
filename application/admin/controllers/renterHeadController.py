...
class RenterHeadController:
    ...
    def getRenters():
        ...
        jsonData=Resp.map(['user_id','name','rent_start_date', 'rent_due_date','rent_duration', 'shipping_destination', 'movie' ],data)
...
class QueryModel:
    def getRenters():
        ...
        mrth_shipping_destination, array_agg( array[mvd_id||'', mvd_title]) from movie_renter_head, 
